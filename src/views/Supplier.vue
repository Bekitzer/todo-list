        ...
        return this.$store.state.Order.list.map(order => {
          ...
          return {
            ...
            .filter(order => {
              ...
              return order.orderSupplierRef.id === this.supplier.id && (this.viewSuppliedOnly ? order.statusType !== 'סופק' : order.statusType === 'סופק') && isValidOrderDate && isValidDeliveredAt
            })
      },
      set(value) {
