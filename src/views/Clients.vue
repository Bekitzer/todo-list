...
<script>
  export default {
    ...
    components: {
      'list-clients': require('@/components/Clients/ListClients').default,
      'no-clients': require('@/components/Clients/NoClients').default,
      'dialog-create': require('@/components/Clients/Dialogs/DialogCreate').default,
