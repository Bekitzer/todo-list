      ...
      <v-col cols="12" md="3" sm="3">
        <v-row class="pa-3  pos-rel mb-2 grey lighten-4">
          ...
          <v-col cols="6">
            ...
            <div>
              <a :href="'http://' + client.website" style="text-decoration:none;color:#03616f;"
        ...
        return this.$store.state.Order.list.map(order => {
          ...
          return {
            ...
            .filter(order => {
              ...
              return order.orderClientRef.id === this.client.id && (this.viewSuppliedOnly ? order.statusType !== 'סופק' : order.statusType === 'סופק') && isValidOrderDate && isValidDeliveryDate
            })
      },
      set(value) {
