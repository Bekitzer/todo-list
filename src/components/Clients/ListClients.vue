...
export default {
  ...
  data: () => ({
    headers: [
      { text: 'מס׳ לקוח', value: 'number', align: 'start', width: '6%' },
      { text: 'שם לקוח', value: 'name', width: '12%'},
      { text: 'שם חברה', value: 'companyName', width: '15%', 'sortable': false },
      { text: 'ח.פ.', value: 'numberId', width: '10%', 'sortable': false },
      { text: 'איש קשר', value: 'contactName', width: '10%', 'sortable': false },
      { text: 'טלפון', value: 'phoneLink', width: '10%', 'sortable': false },
      { text: 'מייל', value: 'emailLink', width: '8%', 'sortable': false },
      { text: 'כתובת', value: 'address', width: '13%', 'sortable': false },
