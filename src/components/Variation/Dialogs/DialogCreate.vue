    ...
    <v-dialog v-model="dialog" max-width="700">
      <v-card elevation="8" shaped>
        <v-row class="pt-5 pr-5 pl-5">
          ...
          <v-col cols="12" md="6">
            <v-text-field v-model="productName" label="שם מוצר" clearable filled dense hide-details/>
          </v-col>
          <v-col cols="12" md="6">
            <v-select
          ...
          <v-col cols="12" md="6">
            <v-textarea v-model="productInfo" label="מפרט" filled dense hide-details/>
          </v-col>
          <v-col cols="12" md="6">
            <v-textarea v-model="supplierPrices" label="מחירון ספקים" filled dense hide-details/>
          </v-col>
          <v-col cols="12">
            <v-card-actions style="padding:0">
              ...
              <v-btn outlined large color="green" @click="addProduct" :disabled="productFieldInvalid">
                צור
              </v-btn>
            </v-card-actions>
          </v-col>
