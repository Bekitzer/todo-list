		...
		<v-row v-if="!user.isAdmin">
			<v-col cols="12" md="3">
				<v-row class="pa-3 pos-rel mb-2 grey lighten-4">
					<v-col cols="12" md="4">
						<v-avatar style="border: 1px solid black" class="profile" size="100px">
							<v-img :src="clientOrSupplier.avatar" rounded></v-img>
						</v-avatar>
					</v-col>
					<v-col cols="12" md="8">
				...
				<v-row class="pa-3 pos-rel mb-2 grey lighten-4">
					...
					<v-col cols="6">
						<div class="user-information">
							<p class="spc-titles">איש קשר ראשי</p>
							{{ clientOrSupplier.contactName }}
						</div>
						<div class="user-information">
							<p class="spc-titles">טלפון</p>
							{{ clientOrSupplier.phone }}
						</div>
						<div class="user-information">
							<p class="spc-titles">מייל</p>
							{{ clientOrSupplier.email }}
						</div>
					</v-col>
					<v-col cols="6">
						<div class="user-information">
							<p class="spc-titles">וואטסאפ</p>
							{{ clientOrSupplier.whatsapp }}
						</div>
						<div class="user-information">
							<p class="spc-titles">כתובת</p>
							{{ clientOrSupplier.address }}
						</div>
						<div class="user-information">
							<p class="spc-titles">הוראות הגעה</p>
							{{ clientOrSupplier.addressAditional }}
						</div>
					</v-col>
				</v-row>
			</v-col>
